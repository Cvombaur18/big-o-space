...
// ANSWER: I dont think so...not completely sure
...
// ANSWER: Tested on replit and they are completeing the same task.  They do console log differently but have the same concept 
...
class Challenge {
  constructor() {
    ...
    number (a, b) {
      if (this.cache.hasOwnProperty(a, b)) {
...
const myFac = new Challenge

console.time("not memoized function time");
console.log(nonCacheAddNum(2,4))
console.log(nonCacheAddNum(2,4))
console.log(nonCacheAddNum(2,4))
console.log(nonCacheAddNum(2,4))
